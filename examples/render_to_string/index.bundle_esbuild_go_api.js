(() => {
  ...
  function Counter() {
    ...
    return /* @__PURE__ */ React.createElement("button", { onClick: () => setCount(count + 1) }, "You clicked me ", count, " times");
  }

  // index.js
  globalThis.React = import_react2.default;
  console.log((0, import_server.renderToString)(/* @__PURE__ */ import_react2.default.createElement(App, null)));
})();
